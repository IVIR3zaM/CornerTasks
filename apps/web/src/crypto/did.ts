// did:key (Ed25519) encoder/decoder.
//
// Kept byte-identical to backend/aws/src/lib/did.ts; the cross-implementation
// vector test in tests/crypto.test.ts asserts equivalence with the macOS impl.
